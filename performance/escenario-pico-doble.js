...
// Reto aplicado (sección 8.1): misma arquitectura de escenarios-avanzados.js,
// pero el pico de reportes se DUPLICA (startRate y target x2) para comparar
// el efecto sobre p95, errores, dropped_iterations y CPU.
// No se modifica el código de la API entre ambas versiones.
...
export const options = {
  ...
  scenarios: {
    ...
    // --- Único cambio respecto a escenarios-avanzados.js: pico duplicado ---
    pico_reportes: {
      ...
      startRate: 4, // antes: 2
      timeUnit: '1s',
      preAllocatedVUs: 20, // antes: 10 (más VUs preasignadas para el doble de tasa)
      maxVUs: 80, // antes: 50
      stages: [
        { duration: '15s', target: 40 }, // antes: 20
        { duration: '15s', target: 40 }, // antes: 20
...
export function handleSummary(data) {
  return {
    ...
    stdout: 'Resumen guardado en evidencia/resumen-sesion29-pico-doble.json',
  };
}
