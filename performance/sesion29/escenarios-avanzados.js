...
export function handleSummary(data) {
  return {
    'performance/sesion29/evidencia/resumen-sesion29.json': JSON.stringify(data, null, 2),
    stdout: 'Resumen guardado en performance/sesion29/evidencia/resumen-sesion29.json',
  };
}