// Copia del script anterior pero con el pico duplicado
...
export const options = {
  ...
  scenarios: {
    ...
    // PICO DUPLICADO: 20 -> 40 iteraciones/s
    pico_reportes: {
      executor: 'ramping-arrival-rate',
      exec: 'consultarReporte',
      startTime: '80s',
      startRate: 4,                        // Duplicado: 2 -> 4
      timeUnit: '1s',
      preAllocatedVUs: 20,                 // Duplicado: 10 -> 20
      maxVUs: 80,                          // Duplicado: 50 -> 80
      stages: [
        { duration: '15s', target: 40 },   // Duplicado: 20 -> 40
        { duration: '15s', target: 40 },   // Duplicado: 20 -> 40
...
export function handleSummary(data) {
  return {
    'evidencia/resumen-pico-doble.json': JSON.stringify(data, null, 2),
    stdout: '✅ Prueba con pico doble completada. Resumen guardado.',
  };
}