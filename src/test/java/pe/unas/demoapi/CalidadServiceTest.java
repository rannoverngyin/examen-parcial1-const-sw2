...
// ===== PRUEBAS PARA esAceptable() =====

@Test
void esAceptable_debería_retornar_true_para_70() {
    assertTrue(service.esAceptable(70));
}

@Test
void esAceptable_debería_retornar_true_para_90() {
    assertTrue(service.esAceptable(90));
}

@Test
void esAceptable_debería_retornar_false_para_40() {
