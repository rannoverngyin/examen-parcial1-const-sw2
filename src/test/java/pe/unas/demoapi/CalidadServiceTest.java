...
class CalidadServiceTest {
    ...
    void clasificaCoberturaAlta() {
        ...
        assertEquals(
                "ALTA",
                service.clasificarCobertura(85)
        );
    ...
    void clasificaCoberturaMedia() {
        ...
        assertEquals(
                "MEDIA",
                service.clasificarCobertura(60)
        );
    ...
    void clasificaCoberturaBaja() {
        ...
        assertEquals(
                "BAJA",
                service.clasificarCobertura(30)
        );
