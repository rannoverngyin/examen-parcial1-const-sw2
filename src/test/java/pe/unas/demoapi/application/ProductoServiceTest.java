...
class ProductoServiceTest {
    ...
    @Test
    @DisplayName("PU-04 – No debe aceptar producto vacío")
    ...
    @Test
    @DisplayName("PU-05 – No debe aceptar producto duplicado")
    void noDebeAceptarProductoDuplicado() {
        assertThrows(IllegalArgumentException.class, () -> service.agregar("Laptop"));
        assertThrows(IllegalArgumentException.class, () -> service.agregar("Mouse"));
    }
}
