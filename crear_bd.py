...
print("Insertando 5,000 estudiantes...")
...
print("Generando 80,000 matrículas de prueba...")
...
conn.commit()
conn.close()
print("Base de datos universidad.db creada correctamente con 80k registros.")