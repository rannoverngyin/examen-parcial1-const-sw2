...
# Creación de índices recomendados y compuestos
indices = [
    ...
    # Índice para resolver eficientemente el ejercicio aplicado Q4 (filtro compuesto + nota)
    "CREATE INDEX IF NOT EXISTS idx_matriculas_compuesto_nota ON matriculas(semestre, nota)"
]
...
print("\n=== EJECUTANDO CONSULTAS OPTIMIZADAS (CON ÍNDICES) ===")
