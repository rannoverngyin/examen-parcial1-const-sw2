"""
Reto opcional – Gráfico comparativo de p95
Sesión 30: Benchmarking y análisis de resultados
Construcción de Software II

Genera un gráfico de barras comparando el p95 de latencia por ejecución
(baseline vs optimizado) a partir del CSV consolidado.

Uso:
    python evidencia/sesion30/grafico_p95.py
"""
